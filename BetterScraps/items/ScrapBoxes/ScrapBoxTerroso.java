...
public class ScrapBoxTerroso extends Item {
    public ScrapBoxTerroso(int par1, int textureID) {
        super(par1);
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (!world.isRemote) {
            ...
            if (diceRoll == 1) {
                // Common item
                rewardItem = new ItemStack(Block.dirt);
            } else if (diceRoll == 2 || diceRoll == 3) {
                // Uncommon item
                rewardItem = new ItemStack(Block.sand);
            } else if (diceRoll == 4 || diceRoll == 5) {
                // Rare item
                rewardItem = new ItemStack(Block.gravel);
            } else {
                // Legendary item
                rewardItem = new ItemStack(Block.grass);
            }
