...
public class ScrapBoxMetallico extends Item {
    public ScrapBoxMetallico(int par1, int textureID) {
        super(par1);
        ...
        this.setItemName("sbm");
        this.setMaxStackSize(64);
    }

    final ItemStack RefIr = ic2.api.Items.getItem("refinedIronIngot");
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (!world.isRemote) {
            ...
            if (diceRoll == 1) {
                // Common item
                rewardItem = new ItemStack(Item.ingotIron);
            } else if (diceRoll == 2 || diceRoll == 3) {
                // Uncommon item
                rewardItem = new ItemStack(Items.scrapm);
            } else if (diceRoll == 4 || diceRoll == 5) {
                // Rare item
                rewardItem = new ItemStack(Item.goldNugget);
            } else {
                // Legendary item
                rewardItem = RefIr;
            }
